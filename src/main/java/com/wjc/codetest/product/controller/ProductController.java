...
public class ProductController {
    ...
    */
    ...
    4. 검증: test_getProductListByCategory_1
    */
    ...
    /*
    1. 문제: 카테고리 데이터가 많을 시 리스트에 전부 로딩하여 비용 소모가 큽니다.
    2. 원인: ResponseEntity<List<String>> getProductListByCategory()
    3. 개선안: 파라미터로 Pageable을 받아서 페이징 처리를 하여 반환합니다.
    4. 검증: test_getProductListByCategory_2
    */
    /*
    1. 문제: 메소드 명이 오버로딩 되어있는데 가독성이 매우 안좋아보입니다.
    2. 원인: getProductListByCategory()
    3. 개선안: getCategoryList() 같은 메소드 이름으로 사용합니다.
    */
